...
This github [repo](https://github.com/Enkelena/free-software-habits) contains the work that has been done on developing a Firefox extension called "Free Software Habits", which is the Google Summer of Code project of Enkelena Haxhija under Debian project. The goal as described in GSoC [project proposal](https://danielpocock.com/gsoc-project-beating-cambridge-analytica-at-their-own-game) by Daniel Pocock for the 2018 edition, under Debian's umbrella, is to create more awareness of existing free software, highlight alternatives that otherwise wouldn't be known by the user and change habits into using free software.
...
[Stop / Start logic: normalView.js](https://github.com/Enkelena/free-software-habits/blob/master/normalView/normalView.js)

* Presenting the Free Software list on a web-page that is generated by the database </br>
[generating list to web-page: data.js](https://github.com/Enkelena/free-software-habits/blob/master/docs/scripts/data.js),
which  has the searchbox where you can immidiately get the app you need by filtring the list. </br>
Apps and their alternatives are structured in tables, they are easily recognized. </br>
There is some documentation about the project also. </br>
...
## Work to do
Just so anyone who reads this knows: The goals of this project as proposed earlier, are all fully completed. This extension is avalaible to be used after it is put on Firefox add-ons installation site, or people could debugg and use it as it is. The coding part is all done and it works.
Other additional improvements will be done after GSoC. </br>
