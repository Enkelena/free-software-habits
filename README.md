 ...
 * Extension is controlled by the user from the default popup (the first blue picture *top right* on this documentation)
  Its code is linked to most of the files who do the work of course.
